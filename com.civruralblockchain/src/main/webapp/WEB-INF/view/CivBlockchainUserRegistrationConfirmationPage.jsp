...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <header class="blog-header py-3">
                ...
                <nav class="navbar navbar-light bg-light">
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/">
                        <img src="${pageContext.request.contextPath}/resources/images/Entourage_Logo.jpg" width="30" height="30" class="d-inline-block align-top" alt="">
                    ...
                    <div class="col-8-xsmall d-flex justify-content-end align-items-left">
                        ...
                        <a class="btn btn-sm btn-outline-secondary" href="${pageContext.request.contextPath}/registration">Login/Register</a>
           ...
           <center>
               <p><h1>User registered successfully!</h1></p>
           <hr>
